...
//
//            LogHelper.e(LogHelper.TAG() , "progressTitle : " + progressTitle + ", textWidth : " + textWidth);
//
//            canvas.drawText(progressTitle, (canvas.getWidth() - textWidth) / 2, (canvas.getHeight() + textHeight) / 2, paint);
//        }
    }
